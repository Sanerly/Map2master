...
package com.vison.base_map.widget;
...
import com.vison.base_map.widget.helper.RCAttrs;
import com.vison.base_map.widget.helper.RCHelper;
 ...
 * 作者：GcsSloop
 */
public class RCRelativeLayout extends FrameLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;
